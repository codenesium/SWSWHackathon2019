...
export default class BankAccountSearchComponent extends React.Component<BankAccountSearchComponentProps, BankAccountSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<BankAccountViewModel>(), filteredRecords:new Array<BankAccountViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.BankAccountClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.BankAccounts + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.BankAccounts + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<BankAccountViewModel>(), filteredRecords:new Array<BankAccountViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedBankAccountSearchComponent = Form.create({ name: 'BankAccount Search' })(BankAccountSearchComponent);

/*<Codenesium>
    <Hash>dffd0bcc698bd4adef86a2c5f29ca3b6</Hash>
</Codenesium>*/