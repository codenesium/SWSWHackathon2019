...
import { ArtistSelectComponent } from '../shared/artistSelect'
	interface EmailEditComponentProps {
  form:WrappedFormUtils;
  history:any;
  match:any;
}

interface EmailEditComponentState {
...
class EmailEditComponent extends React.Component<
  EmailEditComponentProps,
  EmailEditComponentState
> {
  state = {
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new EmailMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Emails + '/' + this.state.model!.id,
...
export const WrappedEmailEditComponent = Form.create({ name: 'Email Edit' })(EmailEditComponent);

/*<Codenesium>
    <Hash>a833c1f7c165819a19322d360659609d</Hash>
</Codenesium>*/